...
$siparisDetayIdGetir = $SiparisDetay->siparisDetayIdGetir();


if(isset($_POST['submit']))
{
    $siparisdetayGuncelle = $SiparisDetay->siparisDetayGuncelle();
    if($sipariDetayEkle)
    {
            ...
            <div class="container">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="miktar" value="<?php echo $siparisDetayIdGetir?>">
                    </div>
